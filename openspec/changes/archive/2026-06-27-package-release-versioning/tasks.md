...
- [x] 1.3 Push da tag para `origin` (`git push origin v0.1.0`).
...
- [x] 3.2 Verificar que `openspec/specs/release-versioning/spec.md` foi arquivado corretamente após o merge desta change (via `openspec archive`), confirmando que a capability passa a existir como spec permanente do repo.
